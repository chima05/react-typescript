...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      <motion.div 
      className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6 mb-10 "
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          <motion.div 
            ...
            <p className="mt-8 text-sm">
              ...
              Reprehenderit ullam eaque unde exercitationem natus nulla ad vel
              quibusdam, nisi corrupti?
            </p>
          </motion.div>
          {/* Actions*/}
          <motion.div 
